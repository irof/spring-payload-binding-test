...
class TodoListControllerTest {
    ...
    final TodoListRepository repository = mock(TodoListRepository.class);
    final MockMvc mockMvc = MockMvcBuilders.standaloneSetup(new TodoListController(repository)).build();
